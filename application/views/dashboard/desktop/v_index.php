                    ...
                    <div class="input-group col-md-12">
                        ...
                        <span class="input-group-append">
                            <i class="fa fa-search"
                                style="padding-top: 10px; margin-left: -20px; position: absolute;"></i>
                        </span>
                    </div>
                </div>
            </form>
                ...
                <div id="advertiseIndicators" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="<?= base_url('assets/global/images/no-image.jpg') ?>" class="d-block w-100"
                                alt="img1" width="100" height="130">
                        </div>
                        <div class="carousel-item">
                            <img src="<?= base_url('assets/global/images/no-image.jpg') ?>" class="d-block w-100"
                                alt="img2" width="100" height="130">
                        </div>
                        <div class="carousel-item">
                            <img src="<?= base_url('assets/global/images/no-image.jpg') ?>" class="d-block w-100"
                                alt="img3" width="100" height="130">
                        </div>
                    </div>
